      ...
      <div className="max-w-md w-full bg-gray-200 border-2 p-8 rounded-lg shadow-lg">
        ...
        <div className="text-center space-y-4">
          <div className="space-x-4">
            <Link href="/" passHref>
              <Button className="bg-gradient-to-r from-blue-500 via-teal-500 to-green-500 hover:from-blue-600 hover:via-teal-600 hover:to-green-600 text-white font-semibold cursor-pointer">
                Continue Shopping
              </Button>
            </Link>
          </div>
